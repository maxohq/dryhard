defmodule Dryhard.Naming do
  ...
  ## Examples
      ...
      iex> Dryhard.Naming.resource_name(MyApp.User)
      "user"

      iex> Dryhard.Naming.resource_name(MyApp.UserView, "View")
      "user"
  ...
  ## Examples
      ...
      iex> Dryhard.Naming.unsuffix("MyApp.User", "View")
      "MyApp.User"

      iex> Dryhard.Naming.unsuffix("MyApp.UserView", "View")
      "MyApp.User"
  ...
  ## Examples
      ...
      iex> Dryhard.Naming.underscore("MyApp")
      "my_app"

  In general, `underscore` can be thought of as the reverse of
  `camelize`, however, in some cases formatting may be lost:

      Dryhard.Naming.underscore "SAPExample"  #=> "sap_example"
      Dryhard.Naming.camelize   "sap_example" #=> "SapExample"
  ...
  ## Examples
      ...
      iex> Dryhard.Naming.camelize("my_app")
      "MyApp"

      iex> Dryhard.Naming.camelize("my_app", :lower)
      "myApp"
  ...
  ## Examples
      ...
      iex> Dryhard.Naming.humanize(:username)
      "Username"
      iex> Dryhard.Naming.humanize(:created_at)
      "Created at"
      iex> Dryhard.Naming.humanize("user_id")
      "User"
